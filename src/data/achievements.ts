...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    ...
    description: "Complete 15 chat rounds with Xinggui",
    icon: "🌲",
    agentId: "xinggui",
    constellation: { name: "The Trail", relatedSources: ["chat", "enneagram"] },
    condition: { type: "total_turns", agentId: "xinggui", threshold: 15 },
  },
  {
    id: "campfire_bond",
    name: "Campfire Bond",
    description: "Reach Trusted bond with Xinggui",
    icon: "🔥",
    agentId: "xinggui",
    constellation: { name: "The Campfire", relatedSources: ["chat"] },
    condition: { type: "bond_level", agentId: "xinggui", threshold: 3 },
  },
  {
    id: "hype_squad",
