export const EASTER_EGG_MARKER_ZH = "【🔮 隐藏记忆解锁】";
export const EASTER_EGG_MARKER_EN = "【🔮 Hidden Memory Unlocked】";
...
/** Remove duplicated easter-egg story blocks (preamble + marker + repeat). */
