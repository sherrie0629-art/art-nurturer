...
- 场景必须强烈贴近中国内地年轻人生活，从下列素材池中挑选不重复的 10 个场景（也可同类延展）：
  · 周日 23 点家族群被催婚 / 催孩子；过年回家亲戚连环 dei；公司团建被点唱；
  · 老板凌晨群里发"嗯。"；KPI 季同事抢功；周一早晨地铁迟到 20 分钟；
  · 相亲对象迟到 20 分钟还不发消息；前任在朋友圈晒新欢；闺蜜/兄弟突然借 5000；
  · 双 11 凌晨 1 点购物车 8000 块手指悬在"立即支付"；外卖凉了被催评价；
  · 楼下大爷凶你电瓶车不让停；同事让你帮忙下载付费 PPT 模板；
  · 周五 22 点老板甩来"周末能不能加个班"；体检报告显示"建议复查"；
  · 公司年会被拉去演节目；春运抢票余票 0；过年红包数字尴尬；
  · 朋友群里有人 cue 你"你最懂这个吧"；陌生号码连打三次。
